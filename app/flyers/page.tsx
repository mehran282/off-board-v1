...
export const metadata: Metadata = {
  title: 'Prospekte',
  description: 'Durchsuchen Sie alle verfügbaren Prospekte von verschiedenen Händlern',
};
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container py-8 px-4">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h1 className="text-3xl font-bold">Prospekte</h1>
        </div>
            ...
            {flyers.length > 0 ? (
              <>
                ...
                {totalPages > 1 && (
                  <div className="flex items-center justify-center gap-2">
                    <Link
                      href={`/flyers?page=${Math.max(1, page - 1)}${
                    ...
                    <Link
                      href={`/flyers?page=${Math.min(totalPages, page + 1)}${
                        params.retailerId ? `&retailerId=${params.retailerId}` : ''
                      }`}
                    >
              ...
              <div className="text-center py-12">
                <p className="text-muted-foreground">
                  Keine Prospekte gefunden. Bitte versuchen Sie andere Filter.
                </p>
              </div>
            )}
          </div>
