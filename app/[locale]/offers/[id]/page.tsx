          ...
          <div>
            <div className="flex items-start gap-4 mb-4">
              <Avatar className="h-12 w-12">
                ...
                />
                <AvatarFallback>{offer.retailer.name.charAt(0)}</AvatarFallback>
              </Avatar>
              <div className="flex-1">
                <p className="text-sm text-muted-foreground">{offer.retailer.name}</p>
                {offer.brand && (
            ...
            <h1 className="text-3xl font-bold mb-4">{offer.productName}</h1>
            ...
            <div className="space-y-4 mb-6">
              <div>
                ...
                <p className="text-4xl font-bold">{formatPrice(offer.currentPrice)}</p>
              </div>

              {offer.oldPrice && offer.oldPrice > offer.currentPrice && (
                <div>
                  <p className="text-sm text-muted-foreground mb-1">{t('oldPrice')}</p>
              ...
              {offer.discountPercentage && offer.discountPercentage > 0 && (
                <div>
                  <p className="text-sm text-muted-foreground mb-1">{t('discount')}</p>
              ...
              {offer.unitPrice && (
                <div>
                  ...
                  <p className="font-semibold">{offer.unitPrice}</p>
                </div>
              )}
            ...
            {offer.flyer && (
              <div className="mb-6 p-4 border rounded-lg">
                <p className="text-sm text-muted-foreground mb-2">{t('fromFlyer')}</p>
                <Link
